        ...
        <div class="line">
          <div class="margin">
            ...
            <div class="s-12 m-12 l-6">
              ...
              <form name="contactForm" class="customform" method="post" action="{{ url('article')}}">
                {{ csrf_field() }}
                <div class="line">
                  <div class="margin">
                    <div class="s-12 m-12 l-6">
                      <input name="author" class="author" placeholder="Author Name" title="Author" type="text" />
                ...
                <div class="s-12">
                  <textarea name="content" class="required content" placeholder="Content" rows="3"></textarea>
